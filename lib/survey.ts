...
export const QUESTIONS: Question[] = [
  {
    ...
    title: "Yemekhane tabağını görse annen ne der?",
    sub: "Akşam 18:00, tepsi elde sıra bekliyorsun.",
    aEmoji: "😋", a: "\"Aferin, yiyorsun\"", aSub: "Çeşit var, porsiyon doyuruyor",
    bEmoji: "🥲", b: "\"Gel eve dönüşün\"", bSub: "Menü sürpriz, mide kumarı",
  },
  {
    topic: "TEMİZLİK",
    title: "Terlikle banyoya girebiliyor musun yoksa bot mu lazım?",
    sub: "Sabah 08:00, herkes aynı anda kalktı.",
    aEmoji: "🩴", a: "Terlik yeter", aSub: "Görevli işini yapıyor, zemin kuru",
    bEmoji: "🥾", b: "Galoşu olan kazanır", bSub: "Kendi malzemenle savaş",
  },
  {
    topic: "İNTERNET",
  ...
  {
    topic: "ODA ARKADAŞI",
    title: "Oda arkadaşınla TikTok çekilir mi kavga mı edilir?",
    sub: "İlk hafta geçti, karakter çözülüyor.",
    aEmoji: "🤳", a: "BFF olundu", aSub: "Uyumlu, saygılı, eğlenceli",
    bEmoji: "📦", b: "Odadan taşınma planı var", bSub: "Her akşam yeni bir sürpriz",
  },
  {
    topic: "KONUM / ULAŞIM",
    title: "Sabah derse yetişmek için alarmı kaça kuruyorsun?",
    sub: "Ders 08:30, gözlerin yarım açık.",
    aEmoji: "😴", a: "08:00, rahat rahat", aSub: "Yürüme mesafesi, uyku bonusu",
    bEmoji: "⏰", b: "06:30, 3 otobüs var", bSub: "Sabahın köründe yola çık",
  },
  {
    topic: "YÖNETİM",
    ...
    bEmoji: "📋", b: "Sayın müdür, dilekçe bekliyor", bSub: "Cevap: 'kural kural kural'",
  },
  {
    topic: "ORTAM / SOSYAL",
    title: "Akşam çay ocağında ortam var mı yoksa herkes odasına mı kapanıyor?",
    sub: "Saat 21:00, ders bitti, karnın aç.",
    aEmoji: "☕", a: "Muhabbet durmuyor", aSub: "Çay ocağı ikinci ev gibi",
