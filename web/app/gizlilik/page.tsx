    ...
    <div className="min-h-screen bg-paper">
      ...
      <div className="mx-auto max-w-[760px] px-8 pb-20 pt-12 max-md:px-5">
        ...
        <div className="grid gap-8 text-[15px] leading-relaxed text-body">
          ...
          <section className="rounded-card border border-line bg-card px-7 py-6">
            <h2 className="mb-3 text-lg font-semibold text-ink">🍪 Çerezler ve ölçümleme</h2>
            <p>
              Oturumunun açık kalması için zorunlu çerezler kullanıyoruz. Bunun
              yanında siteyi kaç kişinin ziyaret ettiğini anlamak için Google
              Analytics, reklamlarımızın işe yarayıp yaramadığını ölçmek için Meta
              Pikseli kullanıyoruz.
            </p>
            <p className="mt-3">
              Bu araçlara <strong>kimliğinle ilgili hiçbir bilgi göndermiyoruz</strong>:
              ne takma adın, ne e-postan, ne hangi yurdu değerlendirdiğin, ne de
              yorumunun içeriği. Meta&apos;ya yalnızca &ldquo;bir değerlendirme
              tamamlandı&rdquo; sinyali gider; hangi yurt olduğu bilgisi bilinçli
              olarak gönderilmez. Meta&apos;nın form alanlarını otomatik okuyup
              e-posta/telefon gönderdiği &ldquo;gelişmiş eşleştirme&rdquo; özelliği
              kapalıdır.
            </p>
          </section>
          ...
          <section className="rounded-card border border-line bg-card px-7 py-6">
            ...
            <p>
              Kişisel verilerinizi üçüncü taraflarla paylaşmıyoruz. Yasal zorunluluk
              (mahkeme kararı) dışında hiçbir kurum veya kişiye veri aktarımı yapılmaz.
              Zaten aktaracak gerçek isim verimiz yok — e-postanız bile düz metin olarak
              saklanmıyor, yalnızca geri döndürülemez biçimde şifrelenmiş hâli tutuluyor.
            </p>
            <p className="mt-3">
              Yukarıda anlatılan ölçümleme araçları bu kuralın istisnası değildir:
              onlara yalnızca sayfa görüntüleme gibi kimliksiz kullanım verisi gider,
              hesabınıza veya yorumlarınıza bağlanabilecek hiçbir bilgi aktarılmaz.
            </p>
          </section>
        </div>
      </div>
