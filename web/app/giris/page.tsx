...
// Giriş sonrası kullanıcıyı geldiği yere geri gönderir (örn. yarım kalan anket).
// Yalnızca site içi göreli yollara izin verilir — açık yönlendirme açığı olmasın.
function getReturnPath(): string {
  if (typeof window === "undefined") return "/";
  const params = new URLSearchParams(window.location.search);
  const target = params.get("donuş") || params.get("donus");
